            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to PublicWallet.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to PublicWallet, accessible
                  from{" "}
                  <a
                    href="https://www.publicwallet.app/#"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    https://www.publicwallet.app/#
                  </a>
                </p>
              </li>
              <li>
